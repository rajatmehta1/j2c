...
<div class="container">
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-sm btn-danger" href="#">Ask Question</a>
            </div>
        </div>
    </header>
    ...
    <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex">
            ...
            <a class="p-2 text-success font-weight-bold" href="#">Answer</a>
        </nav>
        <nav class="nav d-flex justify-content-end">
            <a class="p-2 text-primary" href="#">Login</a>
            <a class="p-2 text-primary" href="#">Sign Up</a>
        </nav>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <h4 class="pb-3 mb-4 border-bottom">
                What fruits are suitable for a diabetic person ?
            </h4>
        ...
        <aside class="col-md-4 blog-sidebar">
            <div class="p-3 mb-3 bg-light rounded alert alert-dismissible">
                <h5>About</h5>
                <p class="mb-0">
